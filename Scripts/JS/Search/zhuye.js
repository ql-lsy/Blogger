$(function () {
    ...
    $.ajax({
        ...
        success: function (res) {
            $("#img").attr("src","../Upload/UserImage/" + res[0].UserAvatarUrl + "")
            $("#name").html(res[0].UserName)
            $("#lab").html(res[0].UserLabel)
